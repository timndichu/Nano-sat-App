                      ...
                      if (model.isLatestLoading) {
                        ...
                        content = Container(
                            ...
                            child: Column(children: [
                              ...
                              Text(
                                  '*Temp. Readings as of ${model.latestDate} ${model.latestTime}', textAlign: TextAlign.center,),
                              SizedBox(height: 5)
                            ]));
                      } else {
                        content = Container(
                              ...
                              Row(
                                  ...
                                  children: [
                                    ...
                                    Container(
                                        width: width / 3,
                                        child: Text(
                                            'Latest Altitude reading: ${model.latestAlt} meters',textAlign: TextAlign.center))
                                  ]),
                              Text(
                                  '*Altitude Readings as of ${model.latestDate} ${model.latestTime}', textAlign: TextAlign.center),
                              SizedBox(height: 5)
                            ]));
                      } else {
                        content = Container(
